...
<!-- auto-generated -->
[![coverage](https://img.shields.io/badge/e2e_coverage-84.43%25-olivedrab)](https://github.com/TourmalineCore/inner-circle-items-api/actions/workflows/calculate-tests-coverage-on-pull-request.yml)
[![coverage](https://img.shields.io/badge/units_coverage-14.93%25-crimson)](https://github.com/TourmalineCore/inner-circle-items-api/actions/workflows/calculate-tests-coverage-on-pull-request.yml)
[![coverage](https://img.shields.io/badge/full_coverage-90.69%25-forestgreen)](https://github.com/TourmalineCore/inner-circle-items-api/actions/workflows/calculate-tests-coverage-on-pull-request.yml)
<!-- auto-generated -->
...
You can fetch OpenApi endpoints and types contract using this URL http://localhost:4501/api/swagger/openapi/v1.json. Swagger UI is accessible at http://localhost:4501/api/swagger/index.html. 
