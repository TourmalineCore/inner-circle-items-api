...
You can fetch OpenApi endpoints and types contract using this URL http://localhost:4501/swagger/openapi/v1.json. Swagger UI is accessible at http://localhost:4501/swagger/index.html. 
